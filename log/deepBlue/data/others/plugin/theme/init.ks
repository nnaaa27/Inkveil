...
[position layer="message0" frame="../others/plugin/theme/image/frame_message.png" margint="110" marginl="140" marginr="150" opacity="&mp.frame_opacity" page="fore"]
...
;CSS
[loadcss file="./data/others/plugin/theme/ts09.css"]
...
f.theme_img_list = [
'./data/others/plugin/theme/image/config/off.gif',
'./data/others/plugin/theme/image/config/on.png',
'./data/others/plugin/theme/image/config/check.png',
'./data/others/plugin/theme/image/config/c_btn_back.png',
'./data/others/plugin/theme/image/config/c_btn_back2.png',
'./data/others/plugin/theme/image/config/bg_config.jpg',
...
'./data/others/plugin/theme/image/system/menu_bg.png',
...
'./data/others/plugin/theme/image/system/menu_load_bg.jpg',
'./data/others/plugin/theme/image/system/menu_log_bg.jpg',
...
'./data/others/plugin/theme/image/system/menu_save_bg.jpg',
